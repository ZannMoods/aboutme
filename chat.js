document.addEventListener('DOMContentLoaded', () => {
    ...
    modalConfirmBtn.addEventListener('click', () => {
        chatHistory = [];
        localStorage.removeItem('DikaAiChatHistory');
    ...
    function saveHistory() {
        localStorage.setItem('DikaAiChatHistory', JSON.stringify(chatHistory));
    }

    function loadHistory() {
        const savedHistory = localStorage.getItem('DikaAiChatHistory');
        chatWindow.innerHTML = '';
        if (savedHistory) {
